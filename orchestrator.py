...
from agents.extractor_agent.agent import get_extractor_agent
...
from services import DatabaseService, StorageService
from utils import TranscriptParser
...
class SalesCopilotOrchestrator:
    def __init__(self):
        ...
        self.taskmage_agent = create_taskmage_agent()
    ...
    def _build_extraction_context(self, parsed_data: Dict[str, Any]) -> str:
        return f"""Analyze the following call transcript and extract structured insights:
...
Return your analysis as JSON."""
    ...
    def _build_tasks_context(self, parsed_data: Dict[str, Any]) -> str:
        ...
        return f"""Analyze the following call transcript and identify action items committed to by internal employees.
...
Return the task assignments as JSON."""
    ...
    def _build_hubspot_context(self, layer1_outputs: Dict[str, Any]) -> str:
        return f"""Generate CRM field updates based on the following analysis:
...
Return the CRM update data as JSON."""
    ...
    def _build_email_context(self, layer1_outputs: Dict[str, Any]) -> str:
        return f"""Compose a follow-up email based on the following insights:
